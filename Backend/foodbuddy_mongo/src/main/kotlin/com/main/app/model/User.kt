...
class User (@Id private var email: String, private var name: String?, private var height: Int?,
            ...
            private var allergens: Array<String>?) {

    constructor(email: String, password: String)
            : this(email, null, null, null, null, password, null, null, "default", null)
    ...
    fun toJson(): UserJ {
        return UserJ(this.email, null, this.name, this.height, this.weight, this.lifestyle, this.gender, this.calorieLimit, this.userType, this.allergens)
    }

    fun setExtras(name: String?, height: Int?, weight: Int?, lifestyle: String?, gender: String?, allergens: Array<String>?) {
        this.name = name
        this.height = height
        this.weight = weight
